...
public class AccountGenerator {
    ...
    private static final byte MIN_EMAIL_LENGTH = 6;
    private static final byte MAX_EMAIL_LENGTH = 30;
    private static final String FIRST_NAME = "John";
    private static final String LAST_NAME = "Doe";
    private static final byte BIRTH_DAY = 10;
    private static final String BIRTH_MONTH = "May";
    private static final short BIRTH_YEAR = 1999;
    private static final String GENDER = "Female";
    private static final String SIGN_UP_PAGE = "https://accounts.google.com/SignUp";

    public static void main(String[] args) throws InterruptedException, IOException {
        ResourceBundle locations = ResourceBundle.getBundle("config");
        String driverLocation = locations.getString("driverLocation");
        ...
        Map<String, Integer> mapIpPort = new HashMap();
        ...
        for (Map.Entry<String, Integer> pairIpPort : mapIpPort.entrySet()) {
            ...
            driverProxy.get(SIGN_UP_PAGE);
            driverProxy.findElement(By.id("FirstName")).sendKeys(FIRST_NAME);
            driverProxy.findElement(By.id("LastName")).sendKeys(LAST_NAME);
            ...
            driverProxy.findElement(By.id("Passwd")).sendKeys(PASSWORD);
            driverProxy.findElement(By.id("PasswdAgain")).sendKeys(PASSWORD);
            driverProxy.findElement(By.id("BirthMonth")).click();

            chooseElementFromList(driverProxy, By.cssSelector("[id='BirthMonth'] [class='goog-menuitem-content']"), BIRTH_MONTH);

            driverProxy.findElement(By.id("BirthDay")).sendKeys(Byte.toString(BIRTH_DAY));
            driverProxy.findElement(By.id("BirthYear")).sendKeys(Short.toString(BIRTH_YEAR));
            driverProxy.findElement(By.id("Gender")).click();

            chooseElementFromList(driverProxy, By.cssSelector("[id='Gender'] [class='goog-menuitem-content']"), GENDER);
...
//            writeToFile(email, PASSWORD, credentials);
//            driverProxy.close();
        }
    }
    ...
    private static void writeToFile(String email, String password, List<String> credentials) throws IOException {
        credentials.add(email + "@gmail.com," + password);
        ResourceBundle locations = ResourceBundle.getBundle("config");
        String credentialsLocation = locations.getString("credentialsLocation");
